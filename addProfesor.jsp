<%-- 
    ...
    Created on : Sep 22, 2020, 8:14:00 PM
    Author     : Super User
--%>
...
<body style="background-color:lightgray; font: black;">
    <form method="post">
        <table class="table table-striped table-dark">
            ...
            <tbody>
                <tr>
                    <td scope="row"><input type="text" name="pro_ime" id="pro_ime"></td>
                    <td scope="row"><input type="text" name="pro_prezime" id="pro_prezime"></td>
                    <td scope="row"><input type="text" name="pro_email" id="pro_email"></td>
                    <td scope="row"><input type="text" name="pro_predmet" id="pro_predmet"></td>
                    <td scope="row" value="Dodaj" id="dodajP"><button type="button" class="btn btn-outline-primary">DODAJ</button></td>
                </tr>
            </tbody>
        </table>
    </form>
