<%-- 
    Document   : adminProfesor
    Created on : Sep 24, 2020, 2:43:27 PM
    Author     : Super User
--%>
...
<body style="background-color:lightgray; text-align: center; font: black;">
    ...
    <table class="table table-striped table-dark">
        ...
        %>
        <tr>
            <td><%=resultSet.getString("pro_id")%></td>
            <td><%=resultSet.getString("pro_ime")%></td>
            <td><%=resultSet.getString("pro_prezime")%></td>
            <td><%=resultSet.getString("pro_email")%></td>
            <td><%=resultSet.getString("pro_predmet")%></td>
            <td><a href="updatepro.jsp?id=<%=resultSet.getString("pro_id")%>"><button type="button" class="btn btn-outline-primary">AZURIRAJ</button></a></td> 
            <td><button type="button" id="<%=resultSet.getString("pro_id")%>" class="btn btn-outline-primary delete">IZBRISI</button></td>
        </tr>
        <%
                }
                connection.close();
